...
extern int test_wifi_common_hal_register(void);
extern int test_wifi_client_hal_register(void);
 
int register_hal_l1_tests( void )
{
    int registerFailed=0;

    registerFailed |= test_wifi_common_hal_register();
    registerFailed |= test_wifi_client_hal_register();
