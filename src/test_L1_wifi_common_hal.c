...
*/
void test_l1_wifi_common_hal_positive1_wifi_getStats (void) 
{
    UT_LOG("Entering test_l1_wifi_common_hal_positive1_wifi_getStats...\n");
...
* | Variation / Step | Description | Test Data | Expected Result | Notes |
* | :----: | --------- | ---------- |-------------- | ----- |
* | 01 | Invoke wifi_getRadioStandard() with valid radioIndex (If freq == 5, radioIndex is 1 || if freq == 2, radioIndex = 0),
valid output_string buffer, valid gOnly buffer, valid nOnly buffer and valid acOnly buffer | radioIndex = valid value, output_string = valid buffer, gOnly = valid buffer, nOnly = valid buffer, acOnly = valid buffer | RETURN_OK | Should Pass |
*/
void test_l1_wifi_common_hal_positive1_wifi_getRadioStandard (void) 
{
    ...
    BOOL gOnly = 0, nOnly = 0, acOnly = 0;
    INT retStatus, RADIO_INDEX_0  = 0;
    wifi_sta_stats_t wifi_sta_stats;
    CHAR *ssid = Config_key_new(key_file, "l1_positive1_wifi_getStats", "AP_SSID");
    ...
    UT_LOG("Invoking wifi_getStats to get freq\n");
    memset(&wifi_sta_stats, 0, sizeof(wifi_sta_stats_t));
    wifi_getStats(RADIO_INDEX, &wifi_sta_stats);
    UT_LOG("freq is %d\n",wifi_sta_stats.sta_Frequency);
    int freq = wifi_sta_stats.sta_Frequency / 1000;
    if(freq == 5)
    {
    ...
    {
        UT_LOG("Invoking wifi_getRadioStandard with radioIndex 1. Output Buffer is NOT NULL.\n");
        retStatus = wifi_getRadioStandard(RADIO_INDEX_0, output_string, &gOnly, &nOnly, &acOnly);
    }
...
void test_l1_wifi_common_hal_positive1_wifi_getRadioChannelsInUse (void)
{
    ...
    CHAR output_string[MAX_LENGTH] = {'\0'};
...
* | Variation / Step | Description | Test Data |Expected Result |Notes |
* | :----: | :---------: | :----------: | :--------------: | :-----: |
* | 01 | Invoke wifi_getRadioAutoChannelSupported() with valid radioIndex and valid output_bool | radioIndex = 1, output_bool = non-null | RETURN_OK | Should Pass |
*/
...
void test_l1_wifi_common_hal_positive1_wifi_getNeighboringWiFiDiagnosticResult (void)
{
    ...
    {
        UT_LOG("Array of neighboring access points contains the values: ap_SSID = %s, ap_BSSID = %s, ap_Mode = %s,", neighbor_ap_array[size].ap_SSID, neighbor_ap_array[size].ap_BSSID, neighbor_ap_array[size].ap_Mode); 
		...
		if(!strcmp(neighbor_ap_array[size].ap_EncryptionMode,"") || !strcmp(neighbor_ap_array[size].ap_EncryptionMode,"TKIP") || !strcmp(neighbor_ap_array[size].ap_EncryptionMode,"AES") || !strcmp(neighbor_ap_array[size].ap_EncryptionMode,"TKIP,AES"))  
		{
		...
		for (int i = 0; i < sizeof(neighbor_ap_array[size].ap_ChannelUtilization) / sizeof(neighbor_ap_array[size].ap_ChannelUtilization[size]); i++) {
...
* | Variation / Step | Description | Test Data |Expected Result |Notes |
* | :----: | --------- | ---------- |-------------- | ----- |
* | 01 | Invoke wifi_getNeighboringWiFiDiagnosticResult() with invalid output_array_size. | output_array_size = NULL | Function should return RETURN_ERR | Should fail |
*/
...
* | Variation / Step | Description | Test Data | Expected Result | Notes |
* | :----: | --------- | ---------- |-------------- | ----- |
* | 01 | Invoke wifi_getNeighboringWiFiDiagnosticResult() with invalid radioIndex | radioIndex = 2 | RETURN_ERR | The function should handle invalid inputs and return error |
*/
...
int test_wifi_common_hal_register_post_connect_tests (void)
{
    ...
    UT_add_test(pSuite_post_wifi_connect, "l1_wifi_common_hal_positive1_wifi_getRadioStandard", test_l1_wifi_common_hal_positive1_wifi_getRadioStandard);
    UT_add_test(pSuite_post_wifi_connect, "l1_wifi_common_hal_positive1_wifi_getRadioChannel", test_l1_wifi_common_hal_positive1_wifi_getRadioChannel);
    UT_add_test(pSuite_post_wifi_connect, "l1_wifi_common_hal_positive1_wifi_getSpecificSSIDInfo", test_l1_wifi_common_hal_positive1_wifi_getSpecificSSIDInfo);
    ...
    UT_add_test(pSuite_post_wifi_connect, "l1_wifi_common_hal_positive1_wifi_getStats", test_l1_wifi_common_hal_positive1_wifi_getStats);
